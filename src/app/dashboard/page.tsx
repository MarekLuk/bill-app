...
export default function Dashboard() {
	...
	// 	const newName = prompt("Enter new item name", itemToEdit.name);
	// 	const newCostStr = prompt("Enter new cost", itemToEdit.cost.toString());
	// 	const newQuantityStr = prompt(
	// 		"Enter new quantity",
	// 		itemToEdit.quantity.toString()
	// 	);

	// 	if (newName && newCostStr && newQuantityStr) {
	// 		const newCost = Number(newCostStr);
	// 		const newQuantity = Number(newQuantityStr);
	// 		const newPrice = newCost * newQuantity;
	// 		setItemList((prev) =>
	// 			prev.map((item) =>
	// 				item.id === id
	// 					? {
